...
public class CassandraConfig extends AbstractReactiveCassandraConfiguration {
    ...
    protected String getKeyspaceName() {
        return CassandraConstants.KEYSPACE_DYNAMIC_SIMULATION;
    }
    ...
    public CassandraMappingContext cassandraMapping(Environment env) {
        ...
        mappingContext.setUserTypeResolver(new SimpleUserTypeResolver(cluster(env).getObject(), CassandraConstants.KEYSPACE_DYNAMIC_SIMULATION));
